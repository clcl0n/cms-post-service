...
{
    public async Task<PostWorkflowNextCommandResponse?> HandleAsync(
        PostWorkflowNextCommand request,
    ...
    )
    {
        ...
        return new PostWorkflowNextCommandResponse(post.Id, post.Status);
    }
}
