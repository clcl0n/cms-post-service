...
{
    public async Task<SubTopicUpdateCommandResponse?> HandleAsync(
        SubTopicUpdateCommand request,
    ...
    )
    {
        ...
        return new SubTopicUpdateCommandResponse(response.Id, response.Title);
    }
