...
{
    public async Task<PostWorkflowBackCommandResponse?> HandleAsync(
        PostWorkflowBackCommand request,
    ...
    )
    {
        ...
        return new PostWorkflowBackCommandResponse(post.Id, post.Status);
    }
}
